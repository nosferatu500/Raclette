...
public class NVPAPICaller
{
    ...
    public string APIUsername = "nosferatu2995_api2.mail.ru";
    private string APIPassword = "6K3ZNXDBYME857DF";
    private string APISignature = "AHLFbd2LyuAAhIif0ES5esi6P8iNAIxPbkpwbia2XJl3ZaRIq75tMbIm";
    ...
    public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
    {
        ...
        string returnURL = "https://localhost:44340/Checkout/CheckoutReview.aspx";
        string cancelURL = "https://localhost:44340/Checkout/CheckoutCancel.aspx";

        NVPCodec encoder = new NVPCodec();
        encoder["METHOD"] = "SetExpressCheckout";
        encoder["RETURNURL"] = returnURL;
        encoder["CANCELURL"] = cancelURL;
        encoder["BRANDNAME"] = "Raclette Application";
        ...
        using (ShoppingCartActions myCartOrders = new ShoppingCartActions())
        {
            ...
            for (int i = 0; i < myOrderList.Count; i++)
            {
                ...
                // encoder["L_PAYMENTREQUEST_0_AMT" + i] = Math.Round((decimal) myOrderList[i].Product.UnitPrice, 2).ToString();
                encoder["L_PAYMENTREQUEST_0_AMT" + i] = myOrderList[i].Product.UtcValueAmount;
